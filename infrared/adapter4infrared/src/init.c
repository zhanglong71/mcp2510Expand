...
void RCC_Configuration(void)
{
    ...
    /* GPIOA and GPIOB and GPIOC USART1 clock enable */
...
void GPIO_Configuration(void)
{
    ...
    #if 1
    /** PA.00/01 for LED; (PA.07 for debug)**/
    ...
    #if 1
    /** Configure PC.06,07,08,09 for channel(CAN addr) selector **/
    ...
    #if 1
    /**
     * Configure PC.01 as Output push-pull, PC.00 as input floating for USART2 communicate. 
     **/
    ...
    #if 1
    /* Configure infrared Tx (PA.05) as alternate function push-pull */
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_5;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_2MHz;
    GPIO_Init(GPIOA, &GPIO_InitStructure);
    
    /* Configure infrared channel (PB.00/01/02/03/04) as alternate function push-pull */
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0 | GPIO_Pin_1 | GPIO_Pin_2 | GPIO_Pin_3 | GPIO_Pin_4;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_2MHz;
    GPIO_Init(GPIOB, &GPIO_InitStructure);
    
    /* Configure infrared record Rx (PA.04) as input floating */
    ...
    #if	0
    /* Configure infrared record (PA.06) as input floating */
...
void NVIC_Configuration(void)
{
  ...
  NVIC_InitStructure.NVIC_IRQChannelCmd = ENABLE;
  NVIC_Init(&NVIC_InitStructure);
#if 0   /** UART1 receive data only, interrupt is not necessary **/
