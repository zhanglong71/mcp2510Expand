        ...
        switch(opt)
        {
            ...
            case 'H':   /** help message **/
		        printf("eg: ./host -a ipAddr -p port -s srcClientId -d dstClientId"
                        ...
                        "(./host -a 192.168.1.6 -p 4852 -s 101 -d 102 -u 0 -h 15 -k 1 -t 4 -f 7)\n");
                return  0;
                //break;
            case 'v':   /** version **/
            ...
            default:   /** help message **/
		        printf("eg: ./host -a ipAddr -p port -s srcClientId -d dstClientId -f function -k keyCode -h houseCode(./host -a 192.168.1.6 -p 4852 -s 101 -d 102 -u 0 -h 15 -k 1 -t 4 -f 5)\n");
                break;
        }
    }
